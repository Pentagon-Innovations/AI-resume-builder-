                ...
                <Link to={'/'}>
                    <div className="flex items-center gap-3 cursor-pointer"><div className="p-2 rounded-lg bg-indigo-600">
                        <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            </path></svg></div><div className="flex flex-col"><span className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 to-blue-500">ResumeAlign</span></div></div>
                </Link>
